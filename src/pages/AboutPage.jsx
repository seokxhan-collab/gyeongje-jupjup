    ...
    <div className="site-container site-page">
      ...
      <article className="legal-article">
        ...
        <p>
          ...
          <strong>오늘의 경제 퀴즈</strong>, 한 주간의 경제 흐름을 정리하는{' '}
          <strong>주간 시황 총평</strong>, 뉴스 속 어려운 용어를 매일 하나씩 풀어 설명하는{' '}
          <strong>경제 용어사전</strong>을 자체 콘텐츠로 제공합니다. 모두 원문을 그대로 옮기지 않고
          AI가 새로 구성한 글입니다. 이와 함께 FOMC·한국은행 금통위·CPI·고용지표 등 주요 경제 일정을
          미리 확인할 수 있는 <strong>경제 캘린더</strong>도 제공합니다.
        </p>

        <h3>회원 기능</h3>
        <p>
          회원가입(아이디·닉네임) 후에는 뉴스에 댓글과 좋아요/싫어요 반응을 남기고, 오늘의 퀴즈 순위표에
          닉네임으로 참여할 수 있습니다. 부적절한 댓글은 신고를 통해 자동으로 숨김 처리됩니다.
        </p>
